...
//        }
        ...
        DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream("src/Demo/io_binary_stream/binary.txt"));
        ...
        DataInputStream dataInputStream = new DataInputStream(new FileInputStream("src/Demo/io_binary_stream/binary.txt"));
